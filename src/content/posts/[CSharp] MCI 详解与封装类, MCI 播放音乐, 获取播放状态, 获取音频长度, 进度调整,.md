...
slug: '20210211102111'
published: 2021-02-11T10:21:11+08:00
tags:
  - dotnet
  - mci
  - win32
...
- 如果不对路径进行转换, 那么某些名字长度大于8的文件(准确来说是路径中任何一部分长度大于8)的将无法播放
  ...
  > 短路径与长路径的转换: [[C#/C/C++] GetShortPathName 详解, 长路径转换为短路径](/posts/20210209080535/)
...
> 去这里吧, 在我的另一篇文章中 [[C#] 音乐播放 3 种方式 Demo 与 MCI 音乐播放器封装类.](/posts/20210211104239/) o(〃'▽'〃)o
